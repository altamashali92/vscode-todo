...
//   private static _onDidReceiveMessage: vscode.EventEmitter<any> = new vscode.EventEmitter<any>();
//   public static readonly onDidReceiveMessage: vscode.Event<any> = FlakyTestsPanel._onDidReceiveMessage.event;
...
//       (message) => {
//         console.log("hooray 2! received a message", message);
//         FlakyTestsPanel._onDidReceiveMessage.fire(message);
//       },
//       null,
//       this._disposables
//     );
